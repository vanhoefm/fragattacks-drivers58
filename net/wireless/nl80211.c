...
static const struct nla_policy nl80211_policy[NUM_NL80211_ATTR] = {
	...
	[NL80211_ATTR_HE_6GHZ_CAPABILITY] = NLA_POLICY_EXACT_LEN(sizeof(struct ieee80211_he_6ghz_capa)),
#else
...
#if LINUX_VERSION_IS_GEQ(5,10,0)
	[NL80211_WOWLAN_TCP_DATA_PAYLOAD] = NLA_POLICY_MIN(NLA_BINARY, 1),
#else
...
#if LINUX_VERSION_IS_GEQ(5,10,0)
	[NL80211_WOWLAN_TCP_WAKE_PAYLOAD] = NLA_POLICY_MIN(NLA_BINARY, 1),
	[NL80211_WOWLAN_TCP_WAKE_MASK] = NLA_POLICY_MIN(NLA_BINARY, 1),
#else
